...
Este projeto utiliza sensores de luz (LDR), sensor de distância ultrassônico e umidade (DHT11), integrados com Arduino UNO, para monitorar o nível da água em enchentes e controlar LEDs, um buzzer e dois displays LCD, com base em diferentes condições.
...
Abaixo, um exemplo visual do sistema em funcionamento:
